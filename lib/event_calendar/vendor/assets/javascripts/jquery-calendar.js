...
jQuery(document).ready(function($) {
  ...
  $(".ec-event-bg").on("mouseover", function() {
    ...
    $("#ec-"+event_class_name+"-"+event_id+".ec-event-bg").css("background-color", highlight_color);
  });
  $(".ec-event-bg").on("mouseout", function() {
    event_id = $(this).attr("data-event-id");
		event_class_name = $(this).attr("data-event-class");
    event_color = $(this).attr("data-color");
    $("#ec-"+event_class_name+"-"+event_id+".ec-event-bg").css("background-color", event_color);
  });
